...
/**
 * \mainpage Cypress USB Device Middleware Library 2.0
*
...
* PSoC 6 Peripheral Driver Library(psoc6pdl) included in the project.
*
...
*     the CLK_PATH connected to the configured previously PLL (#2.6).
...
********************************************************************************
*
* This version of the USB Device Middleware was validated for the compatibility 
...
*   </tr>
*   <tr>
*     <td>- ModusToolbox USB Device Personality in Device Configurator</td>
*     <td>1.1</td>
*   </tr>
*   <tr>
*     <td>- ModusToolbox USB Device Configurator</td>
*     <td>2.0</td>
*   </tr>
*   <tr>
...
*
********************************************************************************
* \section group_usb_dev_MISRA MISRA-C Compliance
********************************************************************************
*
...
*     <td>A cast involving pointers is conducted with caution that the pointers 
*         are correctly aligned for the type of object being pointed to.
*     </td>
*   </tr>
*   <tr>
*     <td>11.5</td>
...
*    </td>
*    <td>
*     1. All device descriptors are stored in flash. On the USB Host get descriptor 
*        request, the pointer to descriptor is assigned to a pointer that manages data 
*        transfer losing const qualification. Despite the qualification being lost, the 
*        middleware does not perform any write access using this pointer.
*       
*     2. Some device characteristics are stored in volatile variables. 
*        On the USB Host request, the pointer to a characteristic variable is assigned to 
*        a pointer that manages data transfer losing volatile qualification. 
*        Despite the qualification being lost, this does not cause any 
*        negative impact because the data transfer is managed by the interrupt handler.
*        The same happens when these variables are passed as parameters to memcpy or 
*        memset function. 
*    </td>
*   </tr>
*   <tr>
...
*         input parameters validation fails.</td>
*   </tr>
*   <tr>
*     <td>16.7</td>
*     <td>A</td>
*     <td>A pointer parameter in a function prototype should be declared as a
*         pointer to const if the pointer is not used to modify the addressed
*         object.</td>
*     <td>The usbfs driver and middleware defines general function 
*         prototypes and pointers to functions types but the function's 
*         implementation depends on configuration. Therefore, 
*         some functions' implementation require parameters to be pointers to 
*         const. This is not met because of the generalized implementation 
*         approach.</td>
*   </tr>
* </table>
*
...
*   <b>PSoC 6 Peripheral Driver Library API Reference</b></a>
*
* * <a href="https://www.cypress.com/products/modustoolbox-software-environment">
*   <b>ModusToolbox Software Environment, Quick Start Guide, Documentation, and 
*   Videos</b></a>
*
* * <a href="https://github.com/cypresssemiconductorco/Code-Examples-for-the-ModusToolbox-PSoC-6-SDK">
*   <b>PSoC 6 SDK Examples</b></a>
*
* * <a href="https://www.cypress.com/ModusToolboxUSBConfig"><b>ModusToolbox USB 
*   Configurator Tool Guide</b></a>
*
* * <a href="https://www.cypress.com/ModusToolboxDeviceConfig"><b>ModusToolbox 
*   Device Configurator Tool Guide</b></a>
*
* * <a href="http://www.cypress.com/cy8ckit-062-wifi-bt"><b>PSoC 6 WiFi-BT 
*   Pioneer Kit</b></a>
*
* * <a href="http://www.cypress.com/cy8cproto-062-4343w"><b>PSoC 6 Wi-Fi BT 
*   Prototyping Kit</b></a>
*
* * <a href="http://www.cypress.com/psoc6ds"><b>PSoC 6 MCU Datasheets</b></a>
*
* * <a href="http://www.cypress.com/psoc6an"><b>PSoC 6 MCU Application Notes</b></a>
*
* * <a href="http://www.cypress.com/psoc6trm"><b>PSoC 6 MCU Technical Reference 
*   Manuals</b></a>
*
...
#define CY_USB_DEV_IS_EP_DIR_OUT(endpointAddr)  (0U == ((endpointAddr) & CY_USB_DEV_EP_IN_DIRECTION))
    ...
    #define CY_USB_DEV_GET_CFG_WORD(addr)  ( (uint16_t) (((uint16_t) (* (((uint8_t const *) (addr)) + 1U))) << 8U) | \
                                                                     (* (( uint8_t const *) (addr))) )
#else
